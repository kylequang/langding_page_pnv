...
class Found extends Component {
    ...
    render() {
        return (
            <Container >
                <Row style={{ marginBottom: '20px', marginTop: '20px', textAlign: 'left' }}>
                    {
                        this.state.buildfoundation.map((item) => {
                            return (
                                <Col sm={4} md={4} lg={4}>
                                    <Container className="feature-left" style={{ marginTop: '10px', marginBottom: '10px' }}>
                                        <span className="icon">
                                            <i className={item.icon} />
                                        </span>
                                        <Container className="feature-copy" style={{ color: 'rgb(51, 146, 235)' }}>
