      ...
      <Carousel slide fade fluid>
        <Carousel.Item>
          ...
          <Carousel.Caption id="introduce">
            ITnuoiIT là chương trình gây quỹ cộng đồng nhằm chung sức với PNV để
            dự án "Xây cầu công nghệ" cho các kỹ sư CNTT tương lai được tiếp tục
            trong giai đoạn đặc biệt khó khăn này.
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
          <img
